    ...
    local techData = {
     ...
     [kTechIDShowEnables] = false, [kTechDataTooltipInfo] = "TWO_COMMAND_STATIONS"},           
       ...
       [kTechDataMaxExtents] = Vector(1.5, 1, 0.4),
         ...
         [kTechDataBuildMethodFailedMessage] = "3CCMax",
...
[kTechDataNotOnInfestation] = kPreventMarineStructuresOnInfestation, 
             [kTechDataBuildRequiresMethod] = GetArmsLabQualifications, 
         [kTechDataBuildMethodFailedMessage] = "3 Arms Labs Max to prevent entity count increase",
   ...
   [kTechDataPointValue] = kObservatoryPointValue,
    ...
    [kTechDataTooltipInfo] = "OBSERVATORY_TOOLTIP", 
     [kTechDataObstacleRadius] = 0.25},
                  ...
                  { [kTechDataId] = kTechId.DropshipBeacon, 
      [kTechDataSupply] = kObservatorySupply,
                --   [kTechDataBuildRequiresMethod] = GetCheckObsyLimit, 
      --  [kTechDataBuildMethodFailedMessage] = "Experiment: 3 Max Obs Per Room",  
    --  [kTechDataHint] = "OBSERVATORY_HINT", 
     [kTechDataGhostModelClass] = "MarineGhostModel", 
       [kTechDataRequiresPower] = true,       
      [kTechDataMapName] = Dropship.kMapName,  
      [kTechDataDisplayName] = "DropshipBeacon", 
     [kVisualRange] = Observatory.kDetectionRange, 
    [kTechDataCostKey] = kObservatoryCost,    
     [kTechDataModel] = Observatory.kModelName,    
     --     [kTechDataBuildTime] = kObservatoryBuildTime, 
  [kTechDataMaxHealth] = 8000,   
   [kTechDataEngagementDistance] = kObservatoryEngagementDistance,
    [kTechDataMaxArmor] = 400, 
    [kTechDataInitialEnergy] = kObservatoryInitialEnergy,   
      [kTechDataMaxEnergy] = kObservatoryMaxEnergy, 
  ...
  [kTechDataTooltipInfo] = "ROBOTICS_FACTORY_TOOLTIP",
   ...
   [kTechDataPointValue] = kARCPointValue, [kTechDataHotkey] = Move.T},
     ...
     [kTechDataModel] = Builder.kModelName,   
      ...
      { [kTechDataId] = kTechId.LayStructureARC,  
       [kTechDataMapName] = LayStructures.kMapName,   
        [kTechDataPointValue] = 5,   
      [kTechDataMaxHealth] = 150,  
       [kTechDataDisplayName] = "ARC Blueprint",  
     [kTechDataModel] = Builder.kModelName,   
      [kTechDataCreditCostKey] = 20, 
      [kTechDataCostKey] = 0 },
     ...
     [kTechDataModel] = Builder.kModelName,   
      ...
      { [kTechDataId] = kTechId.LayStructureRobo,  
       [kTechDataMapName] = LayStructures.kMapName,   
        [kTechDataPointValue] = 5,   
      [kTechDataMaxHealth] = 150,  
       [kTechDataDisplayName] = "AntiBody-Factory BluePrint",  
     [kTechDataModel] = Builder.kModelName,   
...
[kStructureAttachRange] = kArmoryWeaponAttachRange,
 [kStructureAttachRequiresPower] = true },
        ...
        // Armor and upgrades
        { [kTechDataId] = kTechId.Jetpack,  [kTechDataMaxHealth] = 800, [kTechDataMapName] = Jetpack.kMapName,                   [kTechDataDisplayName] = "JETPACK", [kTechDataModel] = Jetpack.kModelName, [kTechDataCostKey] = kJetpackCost, [kTechDataSpawnHeightOffset] = kCommanderEquipmentDropSpawnHeight },
 ...
 [kTechDataTooltipInfo] = "Ranged Projectile dealing damage only to armor and structures"},
       ...
       [kTechDataIgnorePathingMesh] = true,
        ...
        -- [kTechDataBuildMethodFailedMessage] = "Cannot drop Hive during suddendeath", 
         [kTechDataSpawnBlock] = true, [kTechDataMaxExtents] = Vector(2, 1, 2), 
         [kTechDataHint] = "HIVE_HINT", [kTechDataAllowStacking] = true, 
        [kTechDataGhostModelClass] = "AlienGhostModel",  
           [kTechDataMapName] = Hive.kMapName,  
            [kTechDataDisplayName] = "HIVE", [kTechDataCostKey] = kHiveCost,        
                    [kTechDataBuildTime] = kHiveBuildTime, 
        [kTechDataModel] = Hive.kModelName,  [kTechDataHotkey] = Move.V,              
            [kTechDataMaxHealth] = kHiveHealth,  [kTechDataMaxArmor] = kHiveArmor,      
                [kStructureAttachClass] = "TechPoint",     
     ...
     [kTechDataPointValue] = kHivePointValue, 
        [kTechDataTooltipInfo] = "HIVE_TOOLTIP", 
          [kTechDataObstacleRadius] = 2}, 
        { [kTechDataId] = kTechId.HiveHeal, [kTechDataDisplayName] = "HEAL", 
      ...
      [kTechDataMaxExtents] = Vector(1, 1.2, .4),
      [kTechDataGrows] = true},
   ...
   [kTechDataGhostModelClass] = "AlienGhostModel",    [kTechDataMapName] = Shade.kMapName,                        [kTechDataDisplayName] = "SHADE",  [kTechDataCostKey] = kShadeCost,      [kTechDataRequiresInfestation] = true,     [kTechDataBuildTime] = kShadeBuildTime, [kTechDataHotkey] = Move.D, [kTechDataModel] = Shade.kModelName,           [kTechDataMaxHealth] = kShadeHealth, [kTechDataMaxArmor] = kShadeArmor,   [kTechDataInitialEnergy] = kShadeInitialEnergy,      [kTechDataMaxEnergy] = kShadeMaxEnergy, [kTechDataPointValue] = kShadePointValue, [kVisualRange] = Shade.kCloakRadius, [kTechDataMaxExtents] = Vector(1, 1.3, .4), [kTechDataTooltipInfo] = "SHADE_TOOLTIP", [kTechDataGrows] = true },
    ...
    [kTechDataTooltipInfo] = "HallucinatedExplosion TOOLTIP"},
     ...
     [kTechDataTooltipInfo] = "Gestations result in 50% hp/armor on completetion, and Upon death, turns you back into a gestating egg (Back into the class you just died as).", },
