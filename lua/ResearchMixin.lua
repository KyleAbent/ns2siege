...
function ResearchMixin:UpdateResearch(deltaTime)
    ...
    if researchNode then
      ...
      //  researchDuration = researchDuration * kResearchMod
        ...
        researchDuration = researchDuration / ConditionalValue(setupbonus, kMarineTeamResearchMod, kResearchMod)
        elseif self:GetTeamNumber() == 2 then
        researchDuration = researchDuration / ConditionalValue(setupbonus, kAlienTeamResearchMod, kResearchMod)
        end
