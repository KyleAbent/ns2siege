...
function GUIPing:Update(deltaTime)
    ...
    for index, entity in ientitylist(Shared.GetEntitiesWithClassname("TeamInfo")) do
        ...
        if pingTime ~= self.expiredPingTime then
            ...
            local expired = GUIAnimateCommanderPing(self.pingItem.Mark, self.pingItem.Border, self.pingItem.Location, pingSize, timeSincePing, kBorderColor, kMarkColor)
