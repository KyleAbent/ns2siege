...
GUIDialogue.kRightOffset = GUIScale(575)
GUIDialogue.kTopOffset = GUIScale(475)
GUIDialogue.kPortraitBackgroundScale = Vector(GUIScale(1), GUIScale(1), 0)
...
GUIDialogue.kPortraitBackgroundCoords = { X1 = 0, Y1 = 0, X2 = 1, Y2 = 1 }
GUIDialogue.kDialogueBackgroundScale = Vector(GUIScale(1), GUIScale(1), 0)
...
GUIDialogue.kDialogueBackgroundCoords = { X1 = 0, Y1 = 0, X2 = 90, Y2 = 90 }
...
GUIDialogue.kPortraitIconScale = Vector(GUIScale(50), GUIScale(50), 0)
GUIDialogue.kPortraitIconCoords = { X1 = 0, Y1 = 0, X2 = 50, Y2 = 50 }
...
GUIDialogue.kPortraitTextFontSize = 18
