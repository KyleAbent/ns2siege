...
function table.random(t)
    ...
    if max > 0 then       
        ...
        return t[math.floor(math.random(1, max))]
    ...
    if(type(t) == "table") then
        ...
        for key, value in pairs(t) do
            ...
            if(type(value) == "table") then
                ...
                table.insert(buffer, string.format("%s = %s", tostring(key), table.tostring(value)))
            ...
            elseif(type(value) == "number") then
                ...
                */
                ...
                table.insert(buffer, string.format("%s = %s", tostring(key), tostring(value)))
                
            elseif(type(value) == "userdata") then
            
                if value.GetClassName then
                    table.insert(buffer, string.format("%s = class \"%s\"", tostring(key), value:GetClassName()))
                end
