...
function AlienTeam:UpdateShellLevel()
    ...
    local level = GetHasCarapaceUpgrade(alien) and carapaceLevel or 0
    local newMaxArmor = (level / 3) * (alien:GetArmorFullyUpgradedAmount() - alien:GetBaseArmor()) + alien:GetBaseArmor()
    if newMaxArmor ~= alien.maxArmor then

        local armorPercent = alien.maxArmor > 0 and alien.armor/alien.maxArmor or 0
        alien.maxArmor = newMaxArmor
        alien:SetArmor(alien.maxArmor * armorPercent)
    
    end
    end
end
function AlienTeam:UpdateAliensMaxHealth()
    for _, player in ipairs( GetEntitiesForTeam("Alien", 2) ) do
      player: SetRepresentingHealthValues()
    end
end
    ...
    if time > (self.timeOfLastAutoHeal + AlienTeam.kStructureAutoHealInterval) then
        ...
        for index = self.lastAutoHealIndex, toIndex do
            ...
            if not entity:isa("Player") then
                ...
                local isOnInfestation       = entity:GetGameEffectMask(kGameEffect.OnInfestation) or entity:isa("TunnelEntrance") or entity:isa("Egg")
                ...
                if ( requiresInfestation and not isOnInfestation ) or ( not isOnInfestation and entity.movedbycommander )  then
...
/*
      self.techTree:AddResearchNode(kTechId.ControlledHallucinationTierOne,     kTechId.ShadeHive,                kTechId.BioMassTwo)  
    self.techTree:AddResearchNode(kTechId.ControlledHallucinationTierTwo,     kTechId.ControlledHallucinationTierOne,      kTechId.BioMassFive)
    self.techTree:AddResearchNode(kTechId.ControlledHallucinationTierThree,     kTechId.ControlledHallucinationTierTwo,                kTechId.None)
     self.techTree:AddBuildNode(kTechId.ControlledHallucination,       kTechId.ControlledHallucinationTierOne,         kTechId.None)
   */ 
        self.techTree:AddBuildNode(kTechId.ControlledHallucination,       kTechId.ShadeHive,         kTechId.BioMassSix)
        self.techTree:AddActivation(kTechId.HallucinationExplosion,                 kTechId.ShadeHive,         kTechId.None)
  ...
  //  self.techTree:AddBuyNode(kTechId.Illusionist, kTechId.ShadeHive, kTechId.None, kTechId.AllAliens)
    ...
    self.techTree:AddActivation(kTechId.InkTriggerOn,                 kTechId.ShadeHive,         kTechId.None) 
    self.techTree:AddActivation(kTechId.InkTriggerOff,                 kTechId.ShadeHive,         kTechId.None) 
    
    
    
    self.techTree:AddSpecial(kTechId.TwoHives)
    self.techTree:AddSpecial(kTechId.ThreeHives)
    self.techTree:AddSpecial(kTechId.FourHives)
    ...
    // abilities unlocked by bio mass: 
        ...
        self.techTree:AddResearchNode(kTechId.CragStackOne,              kTechId.None, kTechId.CragHive, kTechId.AllAliens) 
        self.techTree:AddResearchNode(kTechId.CragStackTwo,              kTechId.None, kTechId.None, kTechId.AllAliens) 
         self.techTree:AddResearchNode(kTechId.CragStackThree,              kTechId.None, kTechId.None, kTechId.AllAliens) 
        self.techTree:AddResearchNode(kTechId.CragArcBonus,              kTechId.None, kTechId.CragHive, kTechId.AllAliens) 
   ...
   self.techTree:AddResearchNode(kTechId.SpiderGorge,              kTechId.None, kTechId.None, kTechId.AllAliens)
   self.techTree:AddResearchNode(kTechId.WhipFlameThrowerChanceDrop,              kTechId.None, kTechId.None, kTechId.AllAliens)
    self.techTree:AddResearchNode(kTechId.PresBonus,              kTechId.None, kTechId.None, kTechId.AllAliens)
    self.techTree:AddBuyNode(kTechId.Web,        kTechId.SpiderGorge)
    ...
    self.techTree:AddResearchNode(kTechId.PrimalScream,              kTechId.None, kTechId.None, kTechId.AllAliens)
    
    // fade researches
    self.techTree:AddResearchNode(kTechId.MetabolizeEnergy,        kTechId.None, kTechId.None, kTechId.AllAliens) 
    self.techTree:AddResearchNode(kTechId.MetabolizeHealth,            kTechId.None, kTechId.None, kTechId.AllAliens)
    self.techTree:AddResearchNode(kTechId.Stab,              kTechId.None, kTechId.None, kTechId.AllAliens)
    self.techTree:AddResearchNode(kTechId.AcidRocket,              kTechId.None, kTechId.None, kTechId.AllAliens)
...
function AlienTeam:OnUpgradeChamberConstructed(upgradeChamber)
    ...
    if upgradeChamber:GetTechId() == kTechId.CragHive then
...
function AlienTeam:OnResearchComplete(structure, researchId)
    ...
    local checkForGainedResearch = { [kTechId.CragHiveTwo] = kTechId.ThickenedSkin,
                                     ...
                                     [kTechId.ShiftHive] = kTechId.Silence,
                                     [kTechId.ShadeHive] = kTechId.Camouflage }
