...
function ServerSponitor:OnEntityKilled(target, attacker, weapon)
    ...
    // defensive programming: clients may not have had their variantData initialized (Monkeys?)
    local attackerPads = attacker.client and attacker.client.variantData and attacker.client.variantData.shoulderPadIndex or -1
    local targetPads = target.client and target.client.variantData and target.client.variantData.shoulderPadIndex or -1
