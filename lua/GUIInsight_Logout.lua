...
local kFontName = Fonts.kAgencyFB_Large
...
function GUIInsight_Logout:Initialize()
    ...
    GUIMakeFontScale(self.logoutText)
    ...
    GUIMakeFontScale(locationTextBack)
...
function GUIInsight_Logout:OnResolutionChanged(oldX, oldY, newX, newY)
