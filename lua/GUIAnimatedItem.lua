...
function GUIAnimatedItem:SetInheritsParentScaling(inherits, time, animName, modFunction, callBack)
    self.guiItem:SetInheritsParentScaling(inherits)
end
...
function GUIAnimatedItem:GetScale()
    return self.guiItem:GetScale()
end
...
function GUIAnimatedItem:GetTextAlignmentX()
    return self.guiItem:GetTextAlignmentX()
end
...
function GUIAnimatedItem:GetTextAlignmentY()
    return self.guiItem:GetTextAlignmentY()
end
