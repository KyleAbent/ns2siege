...
local function GetUnlockIconParams(unlockId)
    ...
    if not kUnlockIconParams then
        ...
        kUnlockIconParams[kTechId.RifleClip] =            { description = "+25 Rifle Clip Researched", bottomText = "Reload to Activate" }
        kUnlockIconParams[kTechId.HeavyRifleTech] =            { description = "Onifle Researched", bottomText = "Buy At Armory" }
        ...
        kUnlockIconParams[kTechId.AdvancedWeaponry] =       { description = "Armory Armor Researched", bottomText = "Heal Armor @ Armory" }
        kUnlockIconParams[kTechId.DetonationTimeTech] =     { description = "EVT_DETONATION_TIME_RESEARCHED" }
        kUnlockIconParams[kTechId.ArmoryArmor] =     { description = "Armories now heal armor" }
        ...
        kUnlockIconParams[kTechId.AcidRocket] = { description = "AcidRocket Researched" }
        kUnlockIconParams[kTechId.PresBonus] = { description = "Pres Bonus Researched" }
        kUnlockIconParams[kTechId.PrimalScream] = { description = "PrimalScream Researched" }
        ...
        kUnlockIconParams[kTechId.SpiderGorge] = { description = "SpideGorge Researched" }
...
GUIEvent.kFontName = Fonts.kAgencyFB_Small
