...
if MarineorJetpackMarineorExoRoll == 2 then
      ...
      //if not Player:isa("Exo") then 
          ...
          // self:NotifyMarine( nil, "%s Attaining weapon to switch to", true, Player:GetName())       //Destroy the entity so it's not dropped, and can be picked up, which is espcially annoyign with ns2+ autopicking it up, rendering this useless unless deleted
           ...
           if WeaponRoll == 2 and Player:GetWeaponInHUDSlot(1) ~= nil and not Player:GetWeaponInHUDSlot(1):isa("Flamethrower") then DestroyEntity(Player:GetWeaponInHUDSlot(1)) Player:GiveItem(Flamethrower.kMapName) self:NotifyMarine( nil, "%s switched to a flamethrower.", true, Player:GetName()) self:AddDelayToPlayer(Player) return end
                      if WeaponRoll == 2 and Player:GetWeaponInHUDSlot(1) == nil then Player:GiveItem(Flamethrower.kMapName) self:NotifyMarine( nil, "%s switched to a flamethrower.", true, Player:GetName()) self:AddDelayToPlayer(Player) return end
           if WeaponRoll == 3 and Player:GetWeaponInHUDSlot(1) ~= nil and not Player:GetWeaponInHUDSlot(1):isa("Rifle") then DestroyEntity(Player:GetWeaponInHUDSlot(1)) Player:GiveItem(Rifle.kMapName) self:NotifyMarine( nil, "%s switched to a rifle.", true, Player:GetName()) self:AddDelayToPlayer(Player) return end
                      if WeaponRoll == 3 and Player:GetWeaponInHUDSlot(1) == nil then Player:GiveItem(Rifle.kMapName) self:NotifyMarine( nil, "%s switched to a rifle.", true, Player:GetName()) self:AddDelayToPlayer(Player) return end
           if WeaponRoll == 4 and not Player:GetWeaponInHUDSlot(3):isa("Welder") then Player:GiveItem(Welder.kMapName) self:NotifyMarine( nil, "%s switched to a welder.", true, Player:GetName()) self:AddDelayToPlayer(Player) return end
                      if WeaponRoll == 4 and not Player:GetWeaponInHUDSlot(3):isa("Axe") then DestroyEntity(Player:GetWeaponInHUDSlot(3)) Player:GiveItem(Axe.kMapName) self:NotifyMarine( nil, "%s switched to a axe.", true, Player:GetName()) self:AddDelayToPlayer(Player) return end
           if WeaponRoll == 5 and Player:GetWeaponInHUDSlot(2) ~= nil and not Player:GetWeaponInHUDSlot(2):isa("Pistol") then DestroyEntity(Player:GetWeaponInHUDSlot(2)) Player:GiveItem(Pistol.kMapName) self:NotifyMarine( nil, "%s switched to a pistol", true, Player:GetName()) self:AddDelayToPlayer(Player) return end
                     if WeaponRoll == 5 and Player:GetWeaponInHUDSlot(2) == nil then Player:GiveItem(Pistol.kMapName) self:NotifyMarine( nil, "%s switched to a pistol", true, Player:GetName()) self:AddDelayToPlayer(Player) return end
           if WeaponRoll == 6 and Player:GetWeaponInHUDSlot(1) ~= nil and not Player:GetWeaponInHUDSlot(1):isa("Shotgun") then DestroyEntity(Player:GetWeaponInHUDSlot(1)) Player:GiveItem(Shotgun.kMapName) self:NotifyMarine( nil, "%s switched to a shotgun.", true, Player:GetName()) self:AddDelayToPlayer(Player) return end
                     if WeaponRoll == 6 and Player:GetWeaponInHUDSlot(2) == nil then Player:GiveItem(Shotgun.kMapName) self:NotifyMarine( nil, "%s switched to a shotgun.", true, Player:GetName()) self:AddDelayToPlayer(Player) return end
          ...
          // if WeaponRoll == 10 then Player:GiveItem(ClusterGrenade.kMapName) self:NotifyMarine( nil, "%s dropped an active cluster grenade.", true, Player:GetName()) self:AddDelayToPlayer(Player) return end
           ...
           if WeaponRoll == 7 and Player:GetWeaponInHUDSlot(4) == nil then Player:GiveItem(LayMines.kMapName) self:NotifyMarine( nil, "%s attained mines", true, Player:GetName()) self:AddDelayToPlayer(Player) return end
  ...
  //   Player:AdjustMaxArmor(Player:GetMaxArmor() * size / 100)
      ...
      if EffectsRoll == 14 then
           if player:isa("Exo") then self:RollPlayer(Player) return end
