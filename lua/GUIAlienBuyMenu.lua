...
function GUIAlienBuyMenu:_InitializeSlots()
    ...
    local anglePerSlot = (math.pi * 0.95) / (#self.slots-1)
    
    for i = 1, #self.slots do
    
        local angle = (i-1) * anglePerSlot + math.pi * (0.2 * -1)
...
function GUIAlienBuyMenu:GetCanSelect(upgradeButton)
    ...
    return upgradeButton.Purchased or AlienBuy_GetTechAvailable(upgradeButton.TechId)
