...
Server.cragSpawnPoints = table.array(10)
Server.shadeSpawnPoints = table.array(10)
...
function GetLoadSpecial(mapName, groupName, values)
    ...
    elseif mapName == Crag.kMapName then
            table.insert(Server.cragSpawnPoints, values.origin)
        success = true
    elseif mapName == Shade.kMapName then
            table.insert(Server.shadeSpawnPoints, values.origin)
        success = true
