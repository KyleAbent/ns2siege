...
function ScenarioHandler:Init()
    ...
    self.handlers = {
        ...
        TunnelEntranceHandler():Init("TunnelEntrance",kAlienTeamType),
...
function TunnelEntranceHandler:Save(tunnelEntrance)
    return string.format("%s|%d", OrientedEntityHandler.Save(self, tunnelEntrance), tunnelEntrance.ownerClientId)
end

function TunnelEntranceHandler:Load(args, classname)
