...
kMarineWeaponEffects =
{
    ...
    draw =
    {
        marineWeaponDrawSounds =
        {
            ...
            {player_sound = "sound/NS2.fev/marine/rifle/draw", classname = "HeavyRifle", done = true},
    ...
    reload = 
    {
        gunReloadEffects =
        {
            {player_sound = "sound/NS2.fev/marine/rifle/reload", classname = "HeavyRifle"},
    ...
    reload_cancel =
    {
        ...
        {
            {stop_sound = "sound/NS2.fev/marine/rifle/reload", classname = "HeavyRifle"},
    ...
    clipweapon_empty =
    {
        emptySounds =
        {
            ...
            {player_sound = "sound/NS2.fev/marine/common/empty", classname = "HeavyRifle", done = true},
