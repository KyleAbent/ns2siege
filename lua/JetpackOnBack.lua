...
PrecacheAsset("cinematics/vfx_materials/jetpack_thruster.surface_shader")
...
if Client then
    ...
    function JetpackOnBack:UpdateJetpackTrails(deltaTime)
        ...
        local trailsVisible = self:GetIsFlying() and self:GetIsVisible() and not GetIsVortexed(player)
