...
function GUIMapAnnotations:AddAnnotation(text, worldOrigin)
    ...
    annotationItem.Item:SetFontName(Fonts.kArial_17)
    ...
    annotationItem.Item:SetScale(GetScaledVector())
    GUIMakeFontScale(annotationItem.Item)
    annotationItem.Item:SetIsVisible(false)
    table.insert(self.annotations, annotationItem)
    
end

function GUIMapAnnotations:OnResolutionChanged(oldX, oldY, newX, newY)
    self:Uninitialize()
    self:Initialize()
end
