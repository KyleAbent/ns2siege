...
function MarineBuy_GetWeaponDescription(techId)
    ...
    if not gWeaponDescription then
        ...
        gWeaponDescription[kTechId.FireBullets] = "New: Effects Grenade Launcher. Here's the rules for other weapons: Experiment: 10% Damage Bonus to Structures. Disables structures while on fire. Cancels Enzyme/Primal/Umbra on players"
        ...
        gWeaponDescription[kTechId.Resupply] = "Checks if you need a medpack and/or ammopack every 10 seconds. Spawns 1 of each or both."
