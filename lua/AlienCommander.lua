...
local gAlienMenuButtons =
{
    ...
    [kTechId.AdvancedMenu] = { kTechId.Drifter, kTechId.ControlledHallucination, kTechId.None, kTechId.None,
                               kTechId.Shell, kTechId.Veil, kTechId.None, kTechId.EtheralGate},
