...
local function SharedUpdate(self, deltaTime)
    ...
    self.isStarving = not self.hasGorgeOwner
        
    if GorgeStructureMixin.kDieImmediatelyOnStarve and not self.hasGorgeOwner and self.timeStarveBegin + GorgeStructureMixin.kStarveDelay < Shared.GetTime() then
