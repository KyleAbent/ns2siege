        ...
        for effectBlockDescription, effectBlockTable in pairs(currentEffectTable) do
            ...
            for effectTableIndex, effectTable in ipairs(effectBlockTable) do
                ...
                elseif type(assetEntry) == "string" then
                    ...
                    if string.len(assetEntry) > 0 then
                        ...
                        if string.find(assetEntry, "%%") ~= nil then
                            ...
                            if log then Log("Precache %s", assetEntry) end    
                ...
                elseif type(assetEntry) == "table" then
                    ...
                    for index, assetNameEntry in ipairs(assetEntry) do
                        if log then Log("Precache %s", assetNameEntry[2]) end    
...
function EffectManager:PrecacheMaterial(material)
    PrecacheAssetIfExists(material .. ".material")
    PrecacheAssetIfExists(material .. ".dds")
    PrecacheAssetIfExists(material .. "_normal.dds")
    PrecacheAssetIfExists(material .. "_opacity.dds")
    PrecacheAssetIfExists(material .. "_specular.dds")
end
