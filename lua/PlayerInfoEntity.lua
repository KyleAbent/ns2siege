...
local techUpgradesTable = { kTechId.Jetpack, kTechId.Welder, kTechId.ClusterGrenade, kTechId.PulseGrenade, kTechId.GasGrenade, kTechId.Mine, kTechId.Carapace, kTechId.Regeneration, kTechId.Aura, kTechId.Phantom, kTechId.Celerity, kTechId.Adrenaline, kTechId.Camouflage, kTechId.Silence, kTechId.Parasite }
