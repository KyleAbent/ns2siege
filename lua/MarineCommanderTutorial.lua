...
local researchWeapons = Resolve("COMMANDER_TUT_RESEARCH_WEAPON_ONE")
local researchWeaponsSteps =
{
    { CompletionFunc = GetHasClassSelected("Armory"), HighlightWorld = GetUnitPosition(kTechId.Armory) },
    { CompletionFunc = GetHasTechUsed({kTechId.ShotgunTech, kTechId.MinesTech, kTechId.GrenadeTech}), HighlightButton = {kTechId.ShotgunTech, kTechId.MinesTech, kTechId.GrenadeTech} },
}
AddCommanderTutorialEntry(15, kMarineTeamType, researchWeapons, researchWeaponsSteps, nil, {GetHasClass("Armory"), TutorialNotHasTech(kTechId.ShotgunTech) }, nil, "ADV_ARMORY")
