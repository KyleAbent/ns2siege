...
if Client then
    ...
    local function OnUpdateWeapons(deltaTime)
        Client.SetDebugText("WeapEff.OnUpdateClient entry")
        ...
        Client.SetDebugText("WeapEff.OnUpdateClient exit")
    end

    Event.Hook("UpdateClient", OnUpdateWeapons, "ClientWeaponsEffectMixin")
