    ...
    function BabblerPheromone:ProcessHit(entity)
        ...
        if entity and (GetAreEnemies(self, entity) or HasMixin(entity, "BabblerCling")) and HasMixin(entity, "Live") and entity:GetIsAlive() then
         ...
         /*
            ...
            if parent.isriding and entity:isa("Player") then
            local drifter = Shared.GetEntity( parent.drifterId ) 
                drifter:GiveOrder(kTechId.EnzymeCloud, entity:GetId(), entity:GetOrigin(), nil, false, false)
            end
         */
