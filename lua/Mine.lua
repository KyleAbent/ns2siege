...
local function Arm(self)
    ...
    if not self.armed and ConditionalValue( Shared.GetMapName() == "ns_siegeaholic_remade" or Shared.GetMapName() == "ns2_trainsiege2" or Shared.GetMapName() ==  "ns2_rockdownsiege2", GetAreSideDoorsOpen(), GetAreFrontDoorsOpen() ) then //and not self:GetParent():GetHasMineMode() then
