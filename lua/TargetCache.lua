...
kMarineStaticTargets = kMarineStaticTargets or StaticTargetType():Init( "MarineStatic", kAlienTeamType, StaticTargetMixin.type )
/** Mobile targets for marines */
kMarineMobileTargets = kMarineMobileTargets or MobileTargetType():Init( "MarineMobile", kAlienTeamType, MobileTargetMixin.type )
/** Static targets for aliens */
kAlienStaticTargets = kAlienStaticTargets or StaticTargetType():Init( "AlienStatic", kMarineTeamType, StaticTargetMixin.type )
/** Mobile targets for aliens */
kAlienMobileTargets = kAlienMobileTargets or MobileTargetType():Init( "AlienMobile", kMarineTeamType, MobileTargetMixin.type )
